...
KNOWN_EMBEDDING_MODELS: tuple[EmbeddingModelMetadata, ...] = (
    EmbeddingModelMetadata(
        ...
        tokenizer_implementation_library="transformers",
        tokenizer_offset_mapping=True,
    ...
    EmbeddingModelMetadata(
        ...
        setup_hint="Install/cache with SentenceTransformers before rebuilding.",
        requires_local_model=True,
        tokenizer_id="hf:sentence-transformers/all-mpnet-base-v2",
        tokenizer_implementation_library="transformers",
        tokenizer_offset_mapping=True,
    ...
    EmbeddingModelMetadata(
        ...
        tokenizer_implementation_library="regex",
        tokenizer_offset_mapping=True,

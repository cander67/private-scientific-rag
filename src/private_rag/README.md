...
- PRD9 export/import/recreate is in progress. Phase 1 adds the portable ZIP export bundle contract and backend export endpoint. Phase 2 adds bundle validation before recreate, including malformed bundle checks, source hash verification, external source mappings, model reports, parser fingerprints, and count summaries. Phase 3 adds backend recreate execution, active history restore, and full-text/vector index rebuild reporting.

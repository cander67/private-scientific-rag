...
PRD4 full-text search coverage includes unit tests for FTS query normalization and field weights, plus API integration coverage for rebuilding a repository index and searching citation-ready chunk results.

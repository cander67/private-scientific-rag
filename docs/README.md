...
- `ollama_chat_models.md`: supported Ollama chat registry guidance, custom local chat model readiness, generic-provider contract, and model-specific follow-up thresholds.

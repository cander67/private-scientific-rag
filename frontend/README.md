...
Current implementation status: PRD1 through PRD9, PRD20, PRD21, and PRD22 are complete and closed. PRD23 Settings Model Catalog and Collection Guardrails is ready for final review. The production frontend includes Repository Dashboard, document manager, source viewer, Search Lab, Chat Workspace, Prompt Sandbox, Settings / Models, Export Center, and Recreate Repository views for home/status navigation, upload, document selection, PDF page thumbnails, chunk provenance inspection, `needs_ocr`/zero-chunk inspection states, reprocess, row-level delete, delete-all, repository default settings, full-text/vector/hybrid/reranked retrieval inspection, local RAG chat with citations, prompt/retrieval/model comparison, portable ZIP export, and bundle validation/recreate.

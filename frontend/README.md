...
Current implementation status: PRD4 is implemented and ready for review. The production frontend includes distinct document manager, source viewer, and Search Lab views for upload, document selection, PDF page thumbnails, chunk provenance inspection, `needs_ocr`/zero-chunk inspection states, reprocess, delete, and full-text retrieval inspection.

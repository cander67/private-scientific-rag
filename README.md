...
- Portable repository ZIP export bundle API with a versioned manifest, settings, prompt library, document/chunk metadata, chat and retrieval history, citations, selected source files, and opt-in sandbox data.

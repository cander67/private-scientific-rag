...
- Complete: PRD13 parser selection, OCR, and page-image text recovery, including parser routing, reprocess, stale-index freshness gates, local OCR recovery, RapidOCR fallback, chunking remediation, parser-label clarity, and accepted PRD29 manual checklist evidence.
...
- Complete: PRD29 PRD13 manual acceptance testing. The tracked checklist is implemented in `../docs/prd13_manual_acceptance.md` and was accepted by the project owner to close PRD13.
...
- PRD13 manual acceptance scope: PRD29 owns the reusable real-dependency/manual-document checklist and evidence capture used to close PRD13 and future OCR/parser regression passes.
...
13. [Parser selection, OCR, and page-image text recovery](13-ocr-page-image-text-recovery.md) - complete
...
29. [PRD13 manual acceptance testing](29-prd13-manual-acceptance-testing.md) - complete

...
- Ready for final review: PRD29 PRD13 manual acceptance testing. The tracked checklist is implemented in `../docs/prd13_manual_acceptance.md`; the next step is running it to close, defer, or waive PRD13.
...
29. [PRD13 manual acceptance testing](29-prd13-manual-acceptance-testing.md) - ready for final review

...
- Open: PRD23 settings model catalog and collection guardrails, with user-testing remediation for model/runtime/docs feedback.
...
PRD23 remains the active implementation plan while user-testing remediation is added. PRD25 and PRD26 capture follow-up interaction work that should not be bundled into PRD23.
...
23. [Settings model catalog and collection guardrails](23-settings-model-catalog-guardrails.md) - active remediation

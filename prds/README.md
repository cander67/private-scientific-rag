...
- Workflow friction scope: PRD32 owns bottom Settings / Models save controls, stale parser/chunk repair actions surfaced from Search Lab and Chat Workspace, chat-session rename/edit affordances, and Chat Workspace full-context inspection remediation. It reuses PRD28's full-repository reprocess contract, keeps index rebuilds explicit, and keeps retrieval previews separate from full model context.
...
32. [Workflow friction remediation](32-workflow-friction-remediation.md) - ready for final review

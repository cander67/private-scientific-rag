...
- `versions/20260708100000_retrieval_runs.py`: creates PRD6 `retrieval_runs` and `retrieval_results` tables for unified retrieval settings, score breakdowns, final ranks, and recent history inspection.
